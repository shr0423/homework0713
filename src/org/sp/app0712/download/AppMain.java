...
public class AppMain extends JFrame implements ActionListener{
	...
	JLabel la_dest;//어느경로로 저장할지 정보를출력할라벨
	JButton bt_down;//다운로드
	JProgressBar bar;
	JFileChooser chooser;
	Thread thread;//다운로드와 프로그래스바 처리를 담당하 쓰레드
	
	public AppMain() {
		t_url=new JTextField();
		bt_dest=new JButton("저장할위칭");
		la_dest=new JLabel("저장할 위치를 등록해주시요");
